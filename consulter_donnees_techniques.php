...
<html lang=fr>
	<head>
		...
		<title>Consulter Données Techniques</title>
	</head>
	<body class="index_body">
		...
		<div class="container">
			<div class="row py-5">	
				<div class="col-12">
					<form method="POST" action="consulter_donnees_techniques.php">
			...
			<div class="container">
				<div class="col-12">
					...
					<?php
						file_put_contents("sketuveu4.txt", json_fix(utf8_encode($output[0])));
					?>
				</div>
			</div>
		</div>
