<?php
	function accordionCCI($date_releve_debut, $valeur_index_brut_debut, $horodate_Index_brut_debut, $valeur_index_converti_debut, $horodate_Index_converti_debut, $date_releve_fin, $valeur_index_brut_fin, $horodate_Index_brut_fin, $valeur_index_converti_fin, $horodate_Index_converti_fin, $date_debut_consommation, $date_fin_consommation, $volume_brut, $coeff_pta, $valeur_pcs, $coeff_conversion, $volume_converti, $energie, $type_qualif_conso){
		$htmlCCI = "";
		// DÉBUT de la div
		...
		$htmlCCI .= "<p>Energie Consommation : " . $type_qualif_conso . "</p>";
	...
	function prettifyCCI($jarOutputCCI){
		...
		for ($i=0; $i < $tailleReponse; $i++) {
			...
			$htmlFinalCCI .= accordionCCI($date_releve_debut, $valeur_index_brut_debut, $horodate_Index_brut_debut, $valeur_index_converti_debut, $horodate_Index_converti_debut, $date_releve_fin, $valeur_index_brut_fin, $horodate_Index_brut_fin, $valeur_index_converti_fin, $horodate_Index_converti_fin, $date_debut_consommation, $date_fin_consommation, $volume_brut, $coeff_pta, $valeur_pcs, $coeff_conversion, $volume_converti, $energie, $type_qualif_conso);
		}
		return $htmlFinalCCI;
	}
?>